...
The system SHALL provide a notification management list where administrators can create, edit, enable, disable, and view notification channel entries independently from login accounts.

#### Scenario: Administrator creates a tg notification channel
- **WHEN** an administrator submits a new notification channel with type `tg`
