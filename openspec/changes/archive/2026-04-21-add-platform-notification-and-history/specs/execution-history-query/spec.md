...
The system SHALL provide an execution history query view that supports filtering by account, platform, execution status, and time range.

#### Scenario: Administrator filters execution history
- **WHEN** an administrator submits query filters for a specific account and a time range
